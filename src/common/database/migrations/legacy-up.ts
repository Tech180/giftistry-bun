...
import { ensureFieldDefinitions } from '../seeds/item-field-definitions.seed';
...
if (require.main === module || (import.meta.url && process.argv[1] && import.meta.url.includes(process.argv[1]))) {
