...
import type { JobProgressRate } from '../interfaces/job-progress-rate.interface';
import { GRAB_PHASE_DETAIL } from '../constants/grab-phase-detail.constant';
import { tokensPerSecondRate } from './job-progress-rate.util';

export function formatGrabPhaseDetail(phase: GrabPhase | null | undefined): string | null {
  if (!phase) return null;
  return GRAB_PHASE_DETAIL[phase] ?? null;
}
