...
import type { AddItemUseCase } from '../../catalog/use-cases/add-item.use-case';
import type { ValidateItemAudienceUseCase } from '../../catalog/use-cases/validate-item-audience.use-case';
import type { Item } from '../../../domain/interfaces/item.interface';
import type { BulkAddItemInput } from '../interfaces/bulk-add-item-input.interface';
import type { BulkAddItemsResult } from '../interfaces/bulk-add-items-result.interface';
import { MAX_BULK_ADD_BATCH } from '../constants/max-bulk-add-batch.constant';
