...
import { canUserViewItem, isItemSuggestion } from '../../../domain/utils/item-visibility.util';
import { ListRole } from '@/common/domain/list-role.vo';
import { resolveItemMetadata } from '../../../domain/utils/resolve-item-metadata.util';
import { sortWishlistItemsByExportOrder } from '../../../domain/utils/sort-wishlist-items.util';
import type { SortableWishlistItem } from '../../../domain/interfaces/sortable-wishlist-item.interface';
import { computeItemClaimSummary } from '../../../domain/utils/compute-item-claim-summary.util';
import { resolveCategoryPresentation } from '../../../domain/utils/format-category-label.util';
import { canViewerSeeSubstitutionOption } from '../../substitutions/utils/can-viewer-see-substitution-option.util';
import { redactClaimsForViewer } from '../../../domain/utils/redact-claims-for-viewer.util';
import type { ListItemsResult } from '../interfaces/list-items-result.interface';
import { groupItemsByCategory } from '../utils/group-items-by-category.util';
import { toGuestItemDto } from '../utils/to-guest-item-dto.util';
