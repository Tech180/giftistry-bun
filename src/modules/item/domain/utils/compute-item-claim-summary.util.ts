import { isMoneyAmountAtLeast } from '@/common/domain/utils/compare-money-amount.util';
...
import type { ItemClaimSummary } from '../interfaces/item-claim-summary.interface';
