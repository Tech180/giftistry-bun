...
import {
  ...
  PLAYWRIGHT_BINARY_NAMES,
  PLAYWRIGHT_EXECUTABLE_ENV_KEYS,
} from '../constants/playwright-executable.constant';
import type { ResolvePlaywrightExecutableDeps } from '../interfaces/resolve-playwright-executable-deps.interface';
...
export function resolvePlaywrightExecutablePath(
  ...
  for (const key of PLAYWRIGHT_EXECUTABLE_ENV_KEYS) {
  ...
  for (const name of PLAYWRIGHT_BINARY_NAMES) {
