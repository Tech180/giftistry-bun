...
import type { ReviewExtractionInput } from '../../domain/interfaces/review-extraction-input.interface';
import type { ReviewExtractorConfig } from '../../domain/interfaces/review-extractor-config.interface';
...
import { compileReviewPrompt } from '../utils/compile-review-prompt.util';
import { parseReviewJson } from '../utils/parse-review-json.util';

export class AiReviewExtractor implements ReviewExtractor {
  ...
  private async extractWithAI(
    ...
    return parseReviewJson(textResponse);
  }
