...
import type { SystemSettingsPayload } from '@/modules/system';
...
import type { CompleteOwnerOnboardingPayload } from '../interfaces/complete-owner-onboarding-payload.interface';
